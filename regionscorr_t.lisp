...
(defun regionscorr-tests ()
  ...
  (let (regcorr1 mskx (*domain-num-bits-list* (list 2 2)))
    (setf regcorr1 (regionscorr-new (list (region-from 'r0X) (region-from 'r1X))))
  ...
  (let (regcorr1 msk1 regcorr2 (*domain-num-bits-list* (list 3 3)))
  ...
  (let (regcorr1 regcorr2 regcorr3 (*domain-num-bits-list* (list 5 5)))
  ...
  (let (regs1 (*domain-num-bits-list* (list 4 3)))
    ...
    (assert (= (regionscorr-length regs1) 2))
