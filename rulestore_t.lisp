...
(defun rulestore-tests ()
  ...
  (let (ruls1 ruls2 ruls3)
    ...
    ;; Test one-result rulestore intersection.
    ...
    (assert (rulestore-eq ruls3 (rulestore-from-str "[[10]]")))

    ;; Test bad one-result rulestore intersection.
    ...
    ; Test bad two-result rulestore intersection.
    (setf ruls1 (rulestore-from-str "[[11] [10]]"))
    (setf ruls2 (rulestore-from-str "[[XX] [X1]]"))
    (setf ruls3 (rulestore-intersection ruls1 ruls2))
    (assert (null ruls3))
  ...
  (let (ruls1 ruls2 ruls3)
    ...
    ;; Test one-result rulestore union.
    (setf ruls1 (rulestore-from-str "[[10]]"))
    (setf ruls2 (rulestore-from-str "[[01]]"))
    (setf ruls3 (rulestore-union ruls1 ruls2))
    (assert (rulestore-p ruls3))
    (assert (rulestore-eq ruls3 (rulestore-from-str "[[Xx]]")))

    ;; Test bad one-result rulestore union.
    (setf ruls1 (rulestore-from-str "[[10]]"))
    (setf ruls2 (rulestore-from-str "[[11]]"))
    (setf ruls3 (rulestore-union ruls1 ruls2))
    (assert (null ruls3))

    ;; Test two-result rulestore unions.
    (setf ruls1 (rulestore-from-str "[[11] [10]]"))
    (setf ruls2 (rulestore-from-str "[[X1] [X0]]"))
    (setf ruls3 (rulestore-union ruls1 ruls2))
    (assert (rulestore-p ruls3))
    ...
    ;; Test bad two-result rulestore unions.
    (setf ruls1 (rulestore-from-str "[[11] [10]]"))
    (setf ruls2 (rulestore-from-str "[[X0] [X0]]"))
    (setf ruls3 (rulestore-union ruls1 ruls2))
    (assert (null ruls3))
